//btn klik LS Perjadin
$(document).on("click", ".btn-deletelsprj", function(e) {
    e.preventDefault();
    var id = $(this).attr("data-id");
    var url = base_url + 'lsperjadin/getLsPerjadin?id=' + id;
    //alert(id);
    $.ajax({
        url: url,
        method: 'GET',
...
$(document).on("click", ".btn-viewlsprj", function(e) {
    e.preventDefault();
    var id = $(this).attr("data-id");
    var url = base_url + 'lsperjadin/getLsPerjadin?id=' + id;
...
$(document).on("click", ".btn-editlsprj", function(e) {
    e.preventDefault();
    var id = $(this).attr("data-id");
    var url = base_url + 'lsperjadin/getLsPerjadin?id=' + id;
    var pathDownload = base_url + 'src/upload/spp/';
