        ...
        //btn klik LPJ Honbul
        $(document).on("click", ".btn-deletehbl", function(e) {
            e.preventDefault();
            var id = $(this).attr("data-id");
            var url = base_url + 'honbul/getHonbulId?id=' + id;
            //  alert(id);
            $.ajax({
                url: url,
                method: 'GET',
        ...
        $(document).on("click", ".btn-viewhbl", function(e) {
            e.preventDefault();
            var id = $(this).attr("data-id");
            var url = base_url + 'honbul/getHonbulId?id=' + id;
        ...
        $(document).on("click", ".btn-edithbl", function(e) {
            e.preventDefault();
            var id = $(this).attr("data-id");
            var url = base_url + 'honbul/getHonbulId?id=' + id;
            //  alert(id);
        ...
        // sampai disini btn klik LPJ Honbul
