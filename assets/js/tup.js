        ...
        //btn klik LPJ TUP
        $(document).on("click", ".btn-deletetup", function(e) {
            e.preventDefault();
            var id = $(this).attr("data-id");
            var url = base_url + 'tup/getTupId?id=' + id;
            //  alert(id);
            $.ajax({
                url: url,
                method: 'GET',
        ...
        $(document).on("click", ".btn-viewtup", function(e) {
            e.preventDefault();
            var id = $(this).attr("data-id");
            var url = base_url + 'tup/getTupId?id=' + id;
        ...
        $(document).on("click", ".btn-edittup", function(e) {
            e.preventDefault();
            var id = $(this).attr("data-id");
            var url = base_url + 'tup/getTupId?id=' + id;
            //  alert(id);
        ...
        // sampai disini btn klik LPJ TUP
