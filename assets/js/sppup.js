//btn klik SPPUP
$(document).on("click", ".btn-deletesppup", function(e) {
    e.preventDefault();
    var id = $(this).attr("data-id");
    var url = base_url + 'sppup/getSppup?id=' + id;
    //alert(id);
    $.ajax({
        url: url,
        method: 'GET',
        ...
        success: function(data) {
            ...
            $("#dkode_sppup").val(data.spp_dok_id);
...
$(document).on("click", ".btn-viewsppup", function(e) {
    e.preventDefault();
    var id = $(this).attr("data-id");
    var url = base_url + 'sppup/getSppup?id=' + id;
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            $("#vkode_sppup").val(data.spp_dok_id);
...
$(document).on("click", ".btn-editsppup", function(e) {
    e.preventDefault();
    var id = $(this).attr("data-id");
    var url = base_url + 'sppup/getSppup?id=' + id;
    var pathDownload = base_url + 'src/upload/spp/';
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            $("#ekode_sppup").val(data.spp_dok_id);
