...
class M_honkeg extends CI_Model
{
    public function getHonkeg($user)
    {
        $query = "SELECT a.lpj_id, a.lpj_nomorsppspm, a.dokumen_id, a.lpj_tgl, a.lpj_nilaispm, a.lpj_uraian, 
                    ...
                    where a.dokumen_id like 'HKG-%' and a.show_item=1
                    and a.created_by = '".$user."'
                    ORDER BY a.lpj_id";
        return $this->db->query($query)->result_array();
    }

    public function kode_hkg()
    {
        ...
        $kodejadi = "HKG-" . $datenow . $kodemax;    // hasilnya ODJ-9921-0001 dst.
        return $kodejadi;
    }

    function ins_honkeg($data)
    {
        $this->db->insert('dokumen_lpj', $data);
    }
    function up_honkeg($data, $id)
    {
        $this->db->update('dokumen_lpj', $data, array('dokumen_id' => $id));
    }

    function hapus_honkeg($dokumen_id, $deleted, $deleted_by)
    {
    ...
    public function getHonkegId($id)
    {
