...
class M_ls3 extends CI_Model
{
    public function getLs3($id)
    {
    ...
    public function getls3By($user)
    {
        $query = "SELECT 	a.spp_id,
                            ...
                            a.created_by
                    FROM spp a
                    WHERE a.spp_dok_id LIKE 'LST-%' 
                    and a.created_by = '" . $user . "' and a.show_item='1'
                    ORDER BY a.spp_id";
        return $this->db->query($query)->result_array();
    }

    public function kode_ls3()
    {
        ...
        $kodejadi = "LST-" . $datenow . $kodemax;    // hasilnya ODJ-9921-0001 dst.
        return $kodejadi;
    }

    function ins_ls3($data)
    {
        $this->db->insert('dokumen_spp', $data);
    }

    function up_ls3($data, $id)
    {
        $this->db->update('dokumen_spp', $data, array('spp_dok_id' => $id));
    }

    function hapus_ls3($dokumen_id, $deleted_date, $deleted_by)
    {
