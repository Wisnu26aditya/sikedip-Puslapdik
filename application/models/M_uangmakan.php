...
{
    public function getUangmakan($id)
    {
    ...
    public function getuangmakanBy($user)
    {
        $query = "SELECT 	a.spp_id,
                            a.spp_no,
                            a.spp_tgl,
                            ...
                            a.created_by
                    FROM spp a
                    WHERE a.spp_dok_id LIKE 'UM-%' 
                    and a.created_by = '" . $user . "' and a.show_item='1'
                    ORDER BY a.spp_id";
        return $this->db->query($query)->result_array();
    }

    public function kode_um()
    {
        ...
        $kodejadi = "UM-" . $datenow . $kodemax;    // hasilnya ODJ-9921-0001 dst.
        return $kodejadi;
    }

    function ins_uangmakan($data)
    {
        $this->db->insert('dokumen_spp', $data);
    }

    function up_uangmakan($data, $id)
    {
        $this->db->update('dokumen_spp', $data, array('spp_dok_id' => $id));
    }

    function hapus_uangmakan($dokumen_id, $deleted_date, $deleted_by)
    {
