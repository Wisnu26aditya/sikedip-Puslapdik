...
class M_up extends CI_Model
{
    public function getUp($user)
    {
        $query = "SELECT a.lpj_id, a.lpj_nomorsppspm, a.dokumen_id, a.lpj_tgl, a.lpj_nilaispm, a.lpj_uraian, 
                    ...
                    where a.dokumen_id like 'UP-%' and a.show_item=1
                    and a.created_by = '".$user."'
                    ORDER BY a.lpj_id";
        return $this->db->query($query)->result_array();
    }

    public function kode_up()
    {
        ...
        $kodejadi = "UP-" . $datenow . $kodemax;    // hasilnya ODJ-9921-0001 dst.
        return $kodejadi;
    }

    function ins_up($data)
    {
        $this->db->insert('dokumen_lpj', $data);
    }
    function up_up($data, $id)
    {
        $this->db->update('dokumen_lpj', $data, array('dokumen_id' => $id));
    }
    function hapus_up($dokumen_id, $deleted, $deleted_by)
    {
