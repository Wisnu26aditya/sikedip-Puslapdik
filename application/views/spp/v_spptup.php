    ...
    <div class="row">
        <div class="col-lg">
            ...
            if ($pilihan['is_upload'] == '1') { ?>
                <a href="" class="btn btn-primary mb-3" data-toggle="modal" data-target="#add_spptup" id="btn_add_spptup"> Tambah Data</a>
            <?php } else { ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php if ($pilihan['is_download'] == '1') { ?>
                                        <!-- 1 : Boleh -->
                                        <span class="btn-viewspptup badge badge-pill badge-success" data-toggle="modal" data-target="#view_spptup" data-id="<?= $id; ?>">View</span>
                                        <span class="btn-editspptup badge badge-pill badge-warning" data-toggle="modal" data-target="#edit_spptup" data-id="<?= $id; ?>">Edit</span>
                                        <span class="btn-deletespptup badge badge-pill badge-danger" data-toggle="modal" data-target="#delete_spptup" data-id="<?= $id; ?>">Delete</span>
                                    <?php } else { ?>
...
<!-- Modal add-->
<div class="modal fade" id="add_spptup" tabindex="-1" role="dialog" aria-labelledby="add_spptupLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <form action="<?= base_url('spptup/simpan_spptup'); ?>" method="post" enctype="multipart/form-data">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="add_spptuplabel">Upload Pengajuan TUP</h5>
                                ...
                                <div class="form-group">
                                    <fieldset>
                                        ...
                                        <div class="row">
                                            <div class="col-md-auto">
                                                <div class="form-group">
                                                    <label for="exampleFormControlFile1">Dokumen DRPP</label>
                                                    <input name="file_drpp" type="file" class="form-control-file">
                                                </div>
                                                <div class="form-group">
                                                    <label for="exampleFormControlFile1">Dokumen SPTB</label>
                                                    <input name="file_sptb" type="file" class="form-control-file">
                                                </div>
                                                <div class="form-group">
...
<div class="modal fade" id="view_spptup" tabindex="-1" role="dialog" aria-labelledby="view_spptupLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <form action="" method="post" enctype="multipart/form-data">
            <input type="text" id="kode_spptup">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="view_spptuplabel">Download Dokumen TUP</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-auto">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="vkode_spptup" name="kode_spptup" value="" readonly>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <fieldset>
                                ...
                                <div class="row">
                                    <div class="col-md-auto">
                                        <div class="form-group">
                                            <label>File DRPP</label>
                                            <a href="" name="file_drpp" id="vfile_drpp" target="_blank" class="btn btn-success btn-sm"><i class="fas fa-fw fa-download" placeholder="download"></i></a>
                                        </div>
                                        <div class="form-group">
                                            <label>File SPTB</label>
                                            <a href="" name="file_sptb" id="vfile_sptb" target="_blank" class="btn btn-success btn-sm"><i class="fas fa-fw fa-download" placeholder="download"></i></a>
                                        </div>
                                    </div>
                                    <div class="col-md-auto">
                                        <div class="form-group">
...
<div class="modal fade" id="edit_spptup" tabindex="-1" role="dialog" aria-labelledby="edit_spptupLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <form action="<?= base_url('spptup/ubah_spptup'); ?>" method="post" enctype="multipart/form-data">
            <input type="hidden" id="kode_spptup" name="kode_spptup" value="">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="edit_spptuplabel">Edit Dokumen TUP</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="col-md-auto">
                                <div class="form-group">
                                    <label>Kode Dokumen</label>
                                    <input type="text" class="form-control" id="ekode_spptup" name="kode_spptup" readonly>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <fieldset>
                                ...
                                <div class="row">
                                    <div class="col-md-auto">
                                        <div class="form-group">
                                            <label>File DRPP</label>
                                            <input id="file_drpp" name="file_drpp" type="file" class="form-control-file">
                                            <input type="text" class="form-control" id="efile_drpp" readonly>
                                        </div>
                                        <div class="form-group">
                                            <label>File SPTB</label>
                                            <input id="file_sptb" name="file_sptb" type="file" class="form-control-file">
                                            <input type="text" class="form-control" id="efile_sptb" readonly>
                                        </div>
                                    </div>
                                    <div class="col-md-auto">
                                        <div class="form-group">
...
<!-- modal hapus -->
<div class="modal fade" id="delete_spptup" tabindex="-1" role="dialog" aria-labelledby="delete_spptupLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="delete_spptuplabel">Perhatian!!</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <div class="container-fluid">
                    <form class="" action="<?= base_url('spptup/hapus_spptup'); ?>" method="post">
                        <div class="position-relative form-group">
                            <p>Apakah Anda Yakin ingin menghapus data <span style="color:red;font-weight:bold" id="txtid"></span> ?</p>
                        </div>
                        <div class="modal-footer">
                            <input type="hidden" id="dkode_spptup" name="dkode_spptup">
                            <input type="hidden" id="dfile_drpp" name="dfile_drpp">
                            <input type="hidden" id="dfile_sptb" name="dfile_sptb">
