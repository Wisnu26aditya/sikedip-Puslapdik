    ...
    <div class="row">
        <div class="col-lg">
            ...
            if ($pilihan['is_upload'] == '1') { ?>
                <a href="" class="btn btn-primary mb-3" data-toggle="modal" data-target="#add_um" id="btn_add_um"> Tambah Data</a>
            <?php } else { ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php if ($pilihan['is_download'] == '1') { ?>
                                        <!-- 1 : Boleh -->
                                        <span class="btn-viewum badge badge-pill badge-success" data-toggle="modal" data-target="#view_um" data-id="<?= $id; ?>">View</span>
                                        <span class="btn-editum badge badge-pill badge-warning" data-toggle="modal" data-target="#edit_um" data-id="<?= $id; ?>">Edit</span>
                                        <span class="btn-deleteum badge badge-pill badge-danger" data-toggle="modal" data-target="#delete_um" data-id="<?= $id; ?>">Delete</span>
                                    <?php } else { ?>
...
<!-- Modal add-->
<div class="modal fade" id="add_um" tabindex="-1" role="dialog" aria-labelledby="add_umLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <form action="<?= base_url('uangmakan/simpan_uangmakan'); ?>" method="post" enctype="multipart/form-data">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="add_umlabel">Upload Pengajuan Uang Makan</h5>
...
<div class="modal fade" id="view_um" tabindex="-1" role="dialog" aria-labelledby="view_umLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <form action="" method="post" enctype="multipart/form-data">
            <input type="text" id="kode_um">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="view_umlabel">Download Dokumen Uang Makan</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-auto">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="vkode_um" name="kode_um" value="" readonly>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
...
<div class="modal fade" id="edit_um" tabindex="-1" role="dialog" aria-labelledby="edit_umLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <form action="<?= base_url('uangmakan/ubah_uangmakan'); ?>" method="post" enctype="multipart/form-data">
            <input type="hidden" id="kode_um" name="kode_um" value="">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="edit_umlabel">Edit Dokumen Uang Makan</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="col-md-auto">
                                <div class="form-group">
                                    <label>Kode Dokumen</label>
                                    <input type="text" class="form-control" id="ekode_um" name="kode_um" readonly>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
...
<!-- modal hapus -->
<div class="modal fade" id="delete_um" tabindex="-1" role="dialog" aria-labelledby="delete_umLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="delete_umlabel">Perhatian!!</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <div class="container-fluid">
                    <form class="" action="<?= base_url('uangmakan/hapus_uangmakan'); ?>" method="post">
                        <div class="position-relative form-group">
                            <p>Apakah Anda Yakin ingin menghapus data <span style="color:red;font-weight:bold" id="txtid"></span> ?</p>
                        </div>
                        <div class="modal-footer">
                            <input type="hidden" id="dkode_um" name="dkode_um">
