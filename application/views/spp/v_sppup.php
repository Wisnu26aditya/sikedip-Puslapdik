    ...
    <div class="row">
        <div class="col-lg">
            ...
            if ($pilihan['is_upload'] == '1') { ?>
                <a href="" class="btn btn-primary mb-3" data-toggle="modal" data-target="#add_sppup" id="btn_add_sppup"> Tambah Data</a>
            <?php } else { ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php if ($pilihan['is_download'] == '1') { ?>
                                        <!-- 1 : Boleh -->
                                        <span class="btn-viewsppup badge badge-pill badge-success" data-toggle="modal" data-target="#view_sppup" data-id="<?= $id; ?>">View</span>
                                        <span class="btn-editsppup badge badge-pill badge-warning" data-toggle="modal" data-target="#edit_sppup" data-id="<?= $id; ?>">Edit</span>
                                        <span class="btn-deletesppup badge badge-pill badge-danger" data-toggle="modal" data-target="#delete_sppup" data-id="<?= $id; ?>">Delete</span>
                                    <?php } else { ?>
...
<!-- Modal add-->
<div class="modal fade" id="add_sppup" tabindex="-1" role="dialog" aria-labelledby="add_sppupLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <form action="<?= base_url('sppup/simpan_sppup'); ?>" method="post" enctype="multipart/form-data">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="add_sppuplabel">Upload Pengajuan UP</h5>
...
<div class="modal fade" id="view_sppup" tabindex="-1" role="dialog" aria-labelledby="view_sppupLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <form action="" method="post" enctype="multipart/form-data">
            <input type="text" id="kode_sppup">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="view_sppuplabel">Download Dokumen UP</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-auto">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="vkode_sppup" name="kode_sppup" value="" readonly>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
...
<div class="modal fade" id="edit_sppup" tabindex="-1" role="dialog" aria-labelledby="edit_sppupLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <form action="<?= base_url('sppup/ubah_sppup'); ?>" method="post" enctype="multipart/form-data">
            <input type="hidden" id="kode_sppup" name="kode_sppup" value="">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="edit_sppuplabel">Edit Dokumen UP</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="col-md-auto">
                                <div class="form-group">
                                    <label>Kode Dokumen</label>
                                    <input type="text" class="form-control" id="ekode_sppup" name="kode_sppup" readonly>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
...
<!-- modal hapus -->
<div class="modal fade" id="delete_sppup" tabindex="-1" role="dialog" aria-labelledby="delete_sppupLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="delete_sppuplabel">Perhatian!!</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <div class="container-fluid">
                    <form class="" action="<?= base_url('sppup/hapus_sppup'); ?>" method="post">
                        <div class="position-relative form-group">
                            <p>Apakah Anda Yakin ingin menghapus data <span style="color:red;font-weight:bold" id="txtid"></span> ?</p>
                        </div>
                        <div class="modal-footer">
                            <input type="hidden" id="dkode_sppup" name="dkode_sppup">
